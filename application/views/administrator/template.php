  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-info' role='alert' style='border-radius:0px; margin-bottom:0px'>
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
          <a href="http://www.PT Bintang Jamtama Sejahtera.com/" style="margin-right:10px; text-decoration:none; font-size: 20px;">Halo.. Selamat datang di halaman administrator, Saat ini anda menggunakan CMS PT Bintang Jamtama Sejahtera :D</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://members.lokomedia.web.id/" style="color: rgb(243, 156, 18);">PT. BJS</a>
        </div>
      <?php } ?>
